...
#f
plot(x,y)
abline(fit,col="blue",lty=1,lwd=2)

abline(-1,0.5,col="orange",ltyy=2,lwd=3)

legend("bottomright", c(" Least square", "pop-Regression"), col = c("blue", "orange"), lty = c(1, 2))
